...
class GenContenidoType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder                                                                                    
            ...
            ->add('margenIzquierda', NumberType::class, array('required' => true))                                
            ->add('margenDerecha', NumberType::class, array('required' => true))                  
