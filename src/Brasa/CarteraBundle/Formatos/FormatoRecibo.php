...
class FormatoRecibo extends \FPDF_FPDF {
    ...
    public function EncabezadoDetalles() {
        $this->Ln(14);
        $header = array('ID', 'TIPO',utf8_decode('NOTA') , utf8_decode('FACTURA'),'DESCUENTO', 'AJUSTE PESO', 'RETE ICA', 'RETE IVA', 'RETE FUENTE', 'VALOR');
        $this->SetFillColor(236, 236, 236);
        $this->SetTextColor(0);
        ...
        $w = array(11, 33,15, 15, 20, 20, 20, 20,20,20,20);
    ...
    public function Body($pdf) {
        ...
        foreach ($arReciboDetalles as $arReciboDetalle) {            
            ...
            $pdf->Cell(15, 4, $arReciboDetalle->getNumeroDocumentoAplicacion(), 1, 0, 'L');  
            $pdf->Cell(15, 4, $arReciboDetalle->getNumeroFactura(), 1, 0, 'L');            
