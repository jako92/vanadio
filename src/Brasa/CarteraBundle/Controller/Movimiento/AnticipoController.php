...
class AnticipoController extends Controller {
    ...
    private function lista() {
        ...
        $this->strListaDql = $em->getRepository('BrasaCarteraBundle:CarAnticipo')->listaDQL(
                $session->get('filtroAnticipoNumero'), $session->get('filtroCodigoCliente'), $session->get('filtroAnticipoEstadoAutorizado'), $session->get('filtroAnticipoEstadoAnulado'), $session->get('filtroAnticipoEstadoImpreso'), $strFechaDesde = $session->get('filtroDesde'), $strFechaHasta = $session->get('filtroHasta'));
    }
