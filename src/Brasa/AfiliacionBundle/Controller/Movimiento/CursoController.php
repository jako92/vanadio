...
class CursoController extends Controller
{
    ...
    private function formularioFiltro() {
        ...
        $form = $this->createFormBuilder()
            ...
            ->add('estadoAutorizado', ChoiceType::class, array('choices'   => array('TODOS' => '2', 'AUTORIZADO' => '1', 'SIN AUTORIZAR' => '0'), 'data' => $session->get('filtroCursoEstadoAutorizado')))                
            ->add('asistencia', ChoiceType::class, array('choices'   => array('TODOS' => '2', 'ASISTIO' => '1', 'NO ASISTIO' => '0'), 'data' => $session->get('filtroCursoAsistencia')))                                
            ->add('estadoFacturado', ChoiceType::class, array('choices'   => array('TODOS' => '2', 'FACTURADO' => '1', 'SIN FACTURAR' => '0'), 'data' => $session->get('filtroCursoEstadoFacturado')))                                
            ->add('estadoPagado', ChoiceType::class, array('choices'   => array('TODOS' => '2', 'PAGADO' => '1', 'SIN PAGAR' => '0'), 'data' => $session->get('filtroCursoEstadoPagado')))                                                
            ->add('estadoAnulado', ChoiceType::class, array('choices'   => array('TODOS' => '2', 'ANULADO' => '1', 'SIN ANULAR' => '0'), 'data' => $session->get('filtroCursoEstadoAnulado')))                                
