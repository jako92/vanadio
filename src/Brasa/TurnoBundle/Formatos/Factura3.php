...
class Factura3 extends \FPDF_FPDF {
    ...
    public function Header() {
        ...
        $this->Cell(115, 5, "XXXXXXX:", 0, 0, 'L', 1);
        $this->SetXY(156, 50);
        $this->SetFont('Arial', 'B', 8);
        ...
        $this->SetFont('Arial', '', 8);
        $this->Cell(115, 5, "XXXXXXXXX:", 0, 0, 'L', 1);
        $this->SetXY(156, 55);
        $this->SetFont('Arial', 'B', 8);
        $this->Cell(25, 5, "2016-12-12:", 0, 0, 'C', 1);
        $this->Cell(25, 5, "2016-12-12:", 0, 0, 'C', 1);
        $this->SetXY(15, 60);
        $this->Cell(25, 5, "OBRA/PUESTO:", 0, 0, 'L', 1);
        $this->SetFont('Arial', '', 8);
        $this->Cell(95, 5, "XXXXXXX:", 0, 0, 'L', 1);
        $this->SetFont('Arial', 'B', 8);
        $this->Cell(20, 5, "DIRECCION:", 0, 0, 'L', 1);        
        $this->SetFont('Arial', '', 8);
        $this->Cell(51, 5, "XXXXXXXXXXXXXXXXXXXXXXX:", 0, 0, 'L', 1);
        $this->SetXY(15, 65);
        $this->SetFont('Arial', 'B', 8);
        $this->Cell(25, 5, "DIRECCION:", 0, 0, 'L', 1);
        $this->SetFont('Arial', '', 8);
        $this->Cell(115, 5, "XXXXXXXX:", 0, 0, 'L', 1);
        $this->SetXY(156, 65);
        $this->SetFont('Arial', 'B', 8);
        ...
        $this->SetFont('Arial', '', 8);
        $this->Cell(50, 5, "XXXXXXXX:", 0, 0, 'L', 1);
        $this->SetFont('Arial', 'B', 8);
        $this->Cell(20, 5, "CIUDAD:", 0, 0, 'L', 1);
        $this->SetFont('Arial', '', 8);
        $this->Cell(45, 5, "XXXXXXXX:", 0, 0, 'L', 1);
        $this->SetXY(156, 70);
        $this->SetFont('Arial', 'B', 8);
        $this->Cell(25, 5, "FORMA PAGO", 0, 0, 'L', 1);
        $this->SetFont('Arial', '', 8);
        $this->Cell(25, 5, "0 DIAS", 0, 0, 'L', 1);
    ...
    public function Body($pdf) {
        $pdf->Rect(15, 85, 139, 100);
        $pdf->Rect(154, 85, 8, 100);
        $pdf->Rect(162, 85, 22, 100);
        $pdf->Rect(184, 85, 22, 100);
        $arFactura = new \Brasa\TurnoBundle\Entity\TurFactura();
    ...
    public function Footer() {
        ...
        $this->Cell(22, 6, number_format("1214522522", 0, '.', ','), 1, 0, 'R');
        $this->Cell(28, 6, 'AIU SERVICIO:', 1, 0, 'L');
        $this->Cell(22, 6, number_format("1214522522", 0, '.', ','), 1, 0, 'R');
        $this->Cell(22, 6, 'SUBTOTAL', 1, 0, 'L');
        $this->Cell(22, 6, number_format("1214522522", 0, '.', ','), 1, 0, 'R');
        $this->SetXY(15,202);        
        $this->Cell(147, 12, 'OBSERVACIONES', 1, 0, 'L');
        ...
        $this->Cell(22, 6, number_format("1214522522", 0, '.', ','), 1, 0, 'R');
        $this->SetXY(15,214);        
        $this->Cell(147, 6, 'VALORES EN LETRAS...', 1, 0, 'L');
        $this->Cell(22, 6, 'NETO', 1, 0, 'L');
        $this->Cell(22, 6, number_format("1214522522", 0, '.', ','), 1, 0, 'R');
        $this->SetXY(15,220);        
        ...
        $this->SetXY(15,232);
        $this->MultiCell(110, 14, "SASASASASS", 1, 'L');
    ...
    public function GenerarEncabezadoFactura($em) {
        ...
        $this->SetXY(50, 37);
        $this->Cell(120, 4, "Resolucion...............................................................", 0, 0, 'C', 0);
        $this->SetXY(50, 40);
