...
class Factura3 extends \FPDF_FPDF {
    ...
    public function Header() {
        ...
        $this->SetFont('Arial', 'B', 8);
        $this->SetXY(15, 50);        
        $this->Cell(25, 5, "CLIENTE1:", 1, 0, 'L', 0);
        $this->SetXY(40, 50);
        $this->Cell(100, 5, "CLIENTE:", 1, 0, 'L', 0);
        $this->SetXY(15, 55);        
        $this->Cell(25, 5, "CLIENTE2:", 1, 0, 'L', 0);
        $this->SetXY(40, 55);
        $this->Cell(100, 5, "CLIENTE:", 1, 0, 'L', 0);
        $this->SetXY(15, 60);        
        $this->Cell(25, 5, "CLIENTE3:", 1, 0, 'L', 0);
        $this->SetXY(40, 60);
        $this->Cell(50, 5, "CLIENTE:", 1, 0, 'L', 0);
        $this->SetXY(15, 65);        
        $this->Cell(25, 5, "CLIENTE4:", 1, 0, 'L', 0);
        $this->SetXY(40, 65);
        $this->Cell(100, 5, "CLIENTE:", 1, 0, 'L', 0);
        $this->SetXY(15, 70);        
        $this->Cell(25, 5, "CLIENTE5:", 1, 0, 'L', 0);
        $this->SetXY(40, 70);
        $this->Cell(50, 5, "CLIENTE:", 1, 0, 'L', 0);
