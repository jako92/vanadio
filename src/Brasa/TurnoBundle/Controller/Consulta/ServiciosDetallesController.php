...
class ServiciosDetallesController extends Controller {
    ...
    private function lista() {
        ...
        $this->strListaDql = $em->getRepository('BrasaTurnoBundle:TurServicioDetalle')->listaConsultaDql(
                $this->codigoServicio, $session->get('filtroCodigoCliente'), $session->get('filtroServicioDetalleEstadoCerrado'), $strFechaHasta, $session->get('filtroTurCodigoCentroCosto'), $session->get('filtroCodigoPuesto')
        );
    }
