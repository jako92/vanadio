...
class ClienteController extends Controller
{
    ...
    private function generarExcel() {
        ...
        $objPHPExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('O1', 'CELULAR FINANCIERO')
                    ->setCellValue('P1', 'GERENTE')
                    ->setCellValue('Q1', 'CELULAR GERENTE')
                    ->setCellValue('R1', 'FACTURA AGRUPADA')
        ...
        foreach ($arClientes as $arCliente) {            
            $objPHPExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('J' . $i, $arCliente->getBarrio())
                    ->setCellValue('K' . $i, $arCliente->getCiudadRel()->getNombre())
