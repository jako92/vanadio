...
class RecursoController extends Controller {
    ...
    private function lista() {
        ...
        $this->strDqlLista = $em->getRepository('BrasaTurnoBundle:TurRecurso')->listaDQL(
                $session->get('filtroNombreRecurso'), $session->get('filtroCodigoRecurso'), "", $session->get('filtroIdentificacionRecurso'), $session->get('filtroCodigoRecursoGrupo'), $session->get('filtroRecursoEstadoRetirado')
        );
    }
    ...
    private function listaEnlazar() {
        ...
        $this->strDqlListaEmpleados = $em->getRepository('BrasaRecursoHumanoBundle:RhuEmpleado')->ListaRecursoDql(
                $session->get('filtroEmpleadoNombre'), $session->get('filtroCodigoCentroCosto'), "", $session->get('filtroIdentificacion'), "", "");
    }
