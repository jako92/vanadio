...
class ProgramacionController extends Controller {
    ...
    private function lista() {
        ...
        $this->strListaDql = $em->getRepository('BrasaTurnoBundle:TurProgramacion')->listaDQL(
                $session->get('filtroProgramacionCodigo'), $session->get('filtroCodigoCliente'), $session->get('filtroProgramacionEstadoAutorizado'), $strFechaDesde, $strFechaHasta, $session->get('filtroProgramacionEstadoAnulado'));
    }
    ...
    private function formularioFiltro() {
        ...
        $form = $this->createFormBuilder()
                ...
                ->add('estadoAnulado', ChoiceType::class, array('choices' => array('TODOS' => '2', 'ANULADO' => '1', 'SIN ANULAR' => '0'), 'data' => $session->get('filtroProgramacionEstadoAnulado')))
