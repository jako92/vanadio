...
class TurFacturaDetalleRepository extends EntityRepository {
    ...
    public function listaDql($codigoFactura = "", $codigoFacturaDetalle = "") {
        ...
        if ($codigoFacturaDetalle != '') {
            $dql .= " AND fd.codigoFacturaDetallePk = " . $codigoFacturaDetalle;
        }
    ...
    public function listaReporteFechaServicioDql($numeroFactura = "", $codigoCliente = "", $boolEstadoAutorizado = "", $strFechaDesde = "", $strFechaHasta = "", $boolEstadoAnulado = "", $codigoFacturaTipo = "") {
        $dql = "SELECT fd FROM BrasaTurnoBundle:TurFacturaDetalle fd JOIN fd.facturaRel f WHERE fd.codigoFacturaDetallePk <> 0";
        if ($numeroFactura != "") {
            $dql .= " AND f.numero = " . $numeroFactura;
        }
    ...
    public function listaReporteRetencionIcaDql($numeroFactura = "", $codigoCliente = "", $boolEstadoAutorizado = "", $strFechaDesde = "", $strFechaHasta = "", $boolEstadoAnulado = "", $codigoFacturaTipo = "") {
        $dql = "SELECT fd FROM BrasaTurnoBundle:TurFacturaDetalle fd JOIN fd.facturaRel f WHERE fd.codigoFacturaDetallePk <> 0";
        if ($numeroFactura != "") {
            $dql .= " AND f.numero = " . $numeroFactura;
        }
    ...
    public function listaConsultaPedidoFacturaComparativoDql($numeroPedido = "", $codigoCliente = "", $strFechaDesde = "", $strFechaHasta = "") {
        ...
        $dql .= " ORDER BY f.codigoClienteFk";
        return $dql;
    }
