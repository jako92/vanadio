...
class TurServicioDetalleRepository extends EntityRepository {
    ...
    public function liquidar($codigoServicioDetalle) {
        ...
        foreach ($arServiciosDetalleCompuesto as $arServicioDetalleCompuesto) {
            ...
            $floValorBaseServicio = $arServicioDetalle->getVrSalarioBase() * $arServicioDetalle->getServicioRel()->getSectorRel()->getPorcentaje();
        ...
        if (count($arrSeleccionados) > 0) {
            ...
            foreach ($arrSeleccionados AS $codigo) {
                ...
                if ($intNumeroRegistros <= 0) {
                    ...
                    $respuesta = "No se puede eliminar el servicio, por que tiene pedidos generados.";
                }
            }
            $em->flush();
        }
