...
/**
 * @ORM\Table(name="tur_soporte_pago_programacion")
 * @ORM\Entity(repositoryClass="Brasa\TurnoBundle\Repository\TurSoportePagoProgramacionRepository")
 */
class TurSoportePagoProgramacion
{
    /**
     * @ORM\Id
     * @ORM\Column(name="codigo_soporte_pago_programacion_pk", type="integer")
     * @ORM\GeneratedValue(strategy="AUTO")
     */
    private $codigoSoportePagoProgramacionPk;      
     ...
     * @return integer
     */
    public function getCodigoSoportePagoProgramacionPk()
    {
        return $this->codigoSoportePagoProgramacionPk;
    }
