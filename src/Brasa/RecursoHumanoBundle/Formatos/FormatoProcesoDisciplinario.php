...
class FormatoProcesoDisciplinario extends \FPDF_FPDF {
    ...
    public function Generar($em, $codigoProcesoDisciplinarioTipo, $codigoProcesoDisciplinario ,$usuario) {
        ob_clean();
    ...
    public function Body($pdf) {
        ...
        $sustitucion20 = $usuarioCarta;
        $sustitucion21 = $usuarioCargo;
        $sustitucion22 = $arProcesoDisciplinario->getComentarios();
        //$cadena = $arContenidoFormato->getContenido();
        $patron1 = '/#1/';
        $patron2 = '/#2/';
        $patron3 = '/#3/';
