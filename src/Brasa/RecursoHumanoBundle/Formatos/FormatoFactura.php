...
class FormatoFactura extends \FPDF_FPDF {
    ...
    public function Footer() {
        ...
        $this->Rect(15, 77, 117, 80);
        $this->Rect(132, 77, 8, 80);
        $this->Rect(140, 77, 22, 80);
        $this->Rect(162, 77, 22, 80);
        $this->Rect(184, 77, 22, 80);
        ...
        $this->Cell(22, 6, number_format($arFactura->getVrNeto(), 0, '.', ','), 1, 0, 'R');
        $this->SetXY(15,210);        
