...
class NotaCredito1 extends \FPDF_FPDF {
    ...
    public function EncabezadoDetalles() {
        ...
        $this->Rect(149, 81, 15, 100);
        $this->Rect(149, 81, 28, 100);
        $this->Rect(177, 81, 28, 100);
        $this->Ln(8);
    }
    ...
    public function Body($pdf) {
        ...
        foreach ($arFacturaDetalles as $arFacturaDetalle) {
            ...
            $pdf->SetFont('Arial', 'B', 9);
            $pdf->Cell(110, 4, substr("", 0, 61), 0, 0, 'L');                        
            $pdf->SetFont('Arial', '', 9);
            $pdf->Cell(15, 4, number_format($arFacturaDetalle->getCodigoFacturaFk(), 0, '.', ','), 0, 0, 'C');
