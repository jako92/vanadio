...
class CartaRetiro extends \FPDF_FPDF {
    ...
    public function Generar($em, $codigoContrato) {
        ...
        $pdf->Output("CartaRetiro$codigoContrato.pdf", 'D');
    }

    public function Header() {
        $arContenidoFormato = new \Brasa\GeneralBundle\Entity\GenContenidoFormato();
        $arContenidoFormato = self::$em->getRepository('BrasaGeneralBundle:GenContenido')->find(3); //Contenido del formato de carta de retiro creado por datafixture
    ...
    public function EncabezadoDetalles() {
        ...
        $arContrato = self::$em->getRepository('BrasaRecursoHumanoBundle:RhuVacacion')->find(self::$codigoContrato);
        $arContenidoFormato = new \Brasa\GeneralBundle\Entity\GenContenidoFormato();
    ...
    public function Body($pdf) {
        ...
        $arContenidoFormato = new \Brasa\GeneralBundle\Entity\GenContenidoFormato();
        $arContenidoFormato = self::$em->getRepository('BrasaGeneralBundle:GenContenido')->find(3); //carta de retiro
