...
class FormatoHojaVida extends \FPDF_FPDF {
    ...
    public function Header() {
        ...
        if($arEmpleado->getRutaFoto() != "") {
            ...
            $strRuta = $arConfiguracion->getRutaRaiz().''.$arConfiguracion->getRutaImagenesVer() . $arEmpleado->getRutaFoto();
        ...
        if ($arEmpleado->getCodigoTipoTiempoFk() == 2){
            $this->Cell(100, 50, number_format($arEmpleado->getVrSalario() / 2, 2, '.', ','), 0, 0, 'C', 0);
        } else {
